...
class SalaryController extends Controller
{
    public function index()
    {
        ...
        return view('karyawan.salary.index', compact(
            'statementPayroll',
            'statementType',
    ...
    public function downloadPayslipPdf(Payroll $payroll)
    {
        ...
        $pdf = Pdf::loadView('karyawan.exports.payslip_pdf', compact('payroll', 'user'))
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('karyawan.exports.salary_pdf', compact('payrolls', 'month', 'year', 'totalAmount', 'user'))
            ->setPaper('A4', 'portrait')
            ->setOptions([
                'isRemoteEnabled' => true,
                'isHtml5ParserEnabled' => true,
    ...
    public function exportCsv(Request $request)
    {
        ...
        $callback = function() use ($payrolls, $periodLabel, $totalAmount, $user) {
            ...
            // Header
            fputcsv($file, ['LAUNDRYAN - EMPLOYEE SALARY REPORT']);
            fputcsv($file, ['Employee Name', $user->name]);
            fputcsv($file, ['Role', 'Employee']);
