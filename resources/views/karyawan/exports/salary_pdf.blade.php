...
<head>
    <meta charset="utf-8">
    <title>Laundryan - Employee Salary Report</title>
    <style>
        @page {
            margin: 0.8cm;
            size: A4 portrait;
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="company-info">
            ...
            <div class="small">Employee Digital Salary Statement</div>
    ...
    <div class="emp-details">
        <div class="emp-details-title">Employee Information</div>
        <table class="emp-details-grid">
            <tr>
                <td width="15%" class="bold">Employee ID:</td>
    ...
    <div class="signature-container">
        <div class="signature-box" style="float: left; text-align: center; margin-left: 30px;">
            ...
            <div class="bold">Employee Signature</div>
