    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <!-- Export PDF -->
                <a :href="'{{ route('karyawan.salary.export.pdf') }}?month=' + exportMonth + '&year=' + exportYear"
                ...
                <!-- Export CSV -->
                <a :href="'{{ route('karyawan.salary.export.csv') }}?month=' + exportMonth + '&year=' + exportYear"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div x-show="showWithdrawModal" 
                ...
                <div class="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden"
                    ...
                    <form :action="'{{ route('karyawan.salary.withdraw', ['payroll' => '__ID__']) }}'.replace('__ID__', activePayroll.id)" method="POST" class="p-6 space-y-6" @submit="loading = true">
                        @csrf
            ...
            <div x-show="showSlipModal" 
                ...
                <div class="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden"
                    ...
                    <div class="bg-gray-50 p-6 border-t border-gray-100 flex items-center justify-end gap-3">
                        <a :href="'{{ route('karyawan.salary.payslip.pdf', ['payroll' => '__PAYROLL__']) }}'.replace('__PAYROLL__', activePayroll.id)"
