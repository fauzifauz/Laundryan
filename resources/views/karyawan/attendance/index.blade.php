<x-app-layout>
    ...
    <div class="py-8 bg-gray-50/50" x-data="{
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-6">
                            ...
                            @elseif(!$attendance->check_out)
                                ...
                                <div class="text-center space-y-6 py-6">
                                    ...
                                    <form id="checkout-form" action="{{ route('karyawan.attendance.check-out') }}" method="POST">
                                        @csrf
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden"
                        ...
                        <form method="GET" action="{{ route('karyawan.attendance.index') }}" class="p-5 space-y-4">
        ...
        <div x-show="showRequestModal"
            ...
            <div class="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden"
                ...
                <form action="{{ route('karyawan.attendance.request') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                    @csrf
    ...
    <script>
        ...
        function capturePhoto() {
            if (!video || !canvas || !photoInput || !form) return;
