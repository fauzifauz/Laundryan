...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'LAUNDRYAN') }}</title>
    ...
    <div class="min-h-screen flex flex-col lg:flex-row overflow-hidden lg:overflow-visible">
        ...
        <div class="hidden lg:flex lg:w-5/12 xl:w-1/2 bg-primary relative overflow-hidden items-center justify-center p-12 xl:p-24 animate-slide-left">
            ...
            <div class="relative z-10 text-white max-w-lg">
                ...
                <h1 class="text-4xl xl:text-6xl font-extrabold mb-8 leading-tight tracking-tight">Security First. Recover Fast.</h1>
                <p class="text-white/80 text-lg xl:text-xl leading-relaxed mb-12">Create a strong password to protect your account and your data. We ensure your recovery is smooth and secure.</p>
                ...
                <div class="flex items-center gap-6 pt-10 border-t border-white/20">
                    ...
                    <div>
                        <p class="text-white font-bold text-xl tracking-wide">Strong Protection</p>
                        <p class="text-white/60 text-sm uppercase tracking-widest font-semibold">Standard Encrypted</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 sm:p-12 md:p-16 lg:p-20 bg-white animate-slide-right">
            <div class="w-full max-w-[440px] animate-fade-up">
                ...
                <div class="mb-10 text-center lg:text-left">
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-3 tracking-tight">New Password</h2>
                    <p class="text-gray-500 text-base sm:text-lg">Please enter your new security credentials.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-1">
                        <label for="password_confirmation" class="text-sm font-semibold text-gray-700 ml-1">Confirm New Password</label>
                        <div class="relative group" x-data="{ show: false }">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 group-focus-within:text-primary transition-colors">lock_reset</span>
                    ...
                    <button type="submit" 
                        class="w-full py-4 bg-primary text-white font-bold rounded-2xl shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
