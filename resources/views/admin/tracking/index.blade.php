                ...
                if (orders?.length > 0 && !offline) {
                    ...
                    orders.forEach(order => {
                        ...
                        <div class="mb-3 bg-gray-50 rounded-2xl p-4 border border-gray-100 shadow-sm relative overflow-hidden">
                            ...
                            <a href="/admin/orders/${order.id}" target="_blank" class="block w-full text-center bg-white border border-gray-200 hover:bg-gray-900 hover:text-white hover:border-gray-900 text-gray-900 text-[10px] font-black py-2 rounded-xl transition-all no-underline shadow-sm">VIEW DETAILS</a>
                        </div>`;
                    });
                    html += `</div>`;
                } else if (offline) {
                    ...
                    if (orders.length > 0 && !off) {
                        ...
                        orders.forEach(o => {
                            ...
                            <div class="mt-2 bg-gray-50/50 rounded-2xl p-3 border border-gray-100">
                                ...
                                <a href="/admin/orders/${o.id}" target="_blank" onclick="event.stopPropagation()" class="block w-full text-center bg-white border border-gray-200 hover:bg-gray-900 hover:text-white text-gray-900 text-[9px] font-black py-1.5 rounded-lg transition-all shadow-sm no-underline">ORDER DETAILS</a>
                            </div>`;
                        });
                        orderHtml += `</div>`;
                    }
